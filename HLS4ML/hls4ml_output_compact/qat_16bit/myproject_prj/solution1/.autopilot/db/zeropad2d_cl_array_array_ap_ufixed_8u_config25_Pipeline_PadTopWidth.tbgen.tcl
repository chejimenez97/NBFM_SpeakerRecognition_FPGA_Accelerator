set moduleName zeropad2d_cl_array_array_ap_ufixed_8u_config25_Pipeline_PadTopWidth
set isTopModule 0
...
set C_modelName {zeropad2d_cl<array,array<ap_ufixed,8u>,config25>_Pipeline_PadTopWidth}
