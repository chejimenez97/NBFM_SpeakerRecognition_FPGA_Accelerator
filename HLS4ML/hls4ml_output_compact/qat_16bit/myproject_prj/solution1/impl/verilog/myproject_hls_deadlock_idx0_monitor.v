...
module myproject_hls_deadlock_idx0_monitor ( // for module myproject_myproject_inst
    ...
    input wire [18:0] inst_block_sigs,
    output wire block
);
...
wire idx1_block;
wire idx3_block;
wire [18:0] process_idle_vec;
wire [18:0] process_chan_block_vec;
wire [18:0] process_axis_block_vec;
