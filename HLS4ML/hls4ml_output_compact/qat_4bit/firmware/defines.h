...
typedef nnet::array<ap_fixed<16,14>, 8*1> conv2_result_t;
typedef ap_fixed<4,3> weight7_t;
typedef ap_fixed<4,3> bias7_t;
typedef nnet::array<ap_fixed<33,21>, 8*1> bn2_result_t;
typedef ap_fixed<16,6> bn2_scale_t;
typedef ap_fixed<16,6> bn2_bias_t;
typedef nnet::array<ap_ufixed<4,3,AP_RND_CONV,AP_SAT,0>, 8*1> layer10_t;
typedef ap_fixed<18,8> act2_table_t;
typedef nnet::array<ap_ufixed<4,3,AP_RND_CONV,AP_SAT,0>, 8*1> layer11_t;
typedef nnet::array<ap_ufixed<4,3,AP_RND_CONV,AP_SAT,0>, 8*1> layer26_t;
typedef nnet::array<ap_fixed<16,14>, 8*1> conv3_result_t;
typedef ap_fixed<4,3> weight12_t;
typedef ap_fixed<4,3> bias12_t;
typedef nnet::array<ap_fixed<33,21>, 8*1> bn3_result_t;
typedef ap_fixed<16,6> bn3_scale_t;
typedef ap_fixed<16,6> bn3_bias_t;
typedef nnet::array<ap_ufixed<4,3,AP_RND_CONV,AP_SAT,0>, 8*1> layer15_t;
typedef ap_fixed<18,8> act3_table_t;
typedef nnet::array<ap_ufixed<4,3,AP_RND_CONV,AP_SAT,0>, 8*1> layer16_t;
typedef nnet::array<ap_fixed<13,11>, 16*1> dense1_result_t;
typedef ap_fixed<4,3> weight18_t;
typedef ap_fixed<4,3> bias18_t;
typedef ap_uint<1> layer18_index;
typedef nnet::array<ap_ufixed<4,3,AP_RND_CONV,AP_SAT,0>, 16*1> layer20_t;
typedef ap_fixed<18,8> act4_table_t;
typedef nnet::array<ap_fixed<13,11>, 10*1> output_result_t;
