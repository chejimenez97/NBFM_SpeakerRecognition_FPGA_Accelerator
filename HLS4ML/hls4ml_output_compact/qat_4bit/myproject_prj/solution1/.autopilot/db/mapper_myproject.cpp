...
unsigned int ap_apatb_input_8_cap_bc;
static AESL_RUNTIME_BC __xlx_input_8_V_size_Reader("../tv/stream_size/stream_size_in_input_8.dat");
...
extern "C" void apatb_myproject_hw(volatile void * __xlx_apatb_param_input_8, volatile void * __xlx_apatb_param_layer23_out) {
using hls::sim::createStream;
auto* sinput_8 = createStream((hls::stream<__cosim_s4__>*)__xlx_apatb_param_input_8);
...
auto* slayer23_out = createStream((hls::stream<__cosim_s20__>*)__xlx_apatb_param_layer23_out);
  // DUT call
  myproject(sinput_8->data<__cosim_s4__>(), slayer23_out->data<__cosim_s20__>());
sinput_8->transfer((hls::stream<__cosim_s4__>*)__xlx_apatb_param_input_8);
