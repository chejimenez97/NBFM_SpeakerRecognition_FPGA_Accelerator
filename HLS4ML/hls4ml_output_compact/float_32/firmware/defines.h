...
typedef nnet::array<ap_fixed<40,20>, 8*1> conv2_result_t;
...
typedef nnet::array<ap_fixed<16,6>, 8*1> layer26_t;
typedef nnet::array<ap_fixed<40,20>, 8*1> conv3_result_t;
...
typedef nnet::array<ap_fixed<37,17>, 16*1> dense1_result_t;
...
typedef nnet::array<ap_fixed<37,17>, 10*1> output_result_t;
