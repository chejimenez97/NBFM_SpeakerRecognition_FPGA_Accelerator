set moduleName myproject_axi_Pipeline_VITIS_LOOP_30_1
set isTopModule 0
...
set C_modelName {myproject_axi_Pipeline_VITIS_LOOP_30_1}
...
set C_modelArgList {
	...
	{ in_stream_V_id_V int 4 regular {axi_s 0 volatile  { in_stream ID } }  }
	{ in_stream_V_dest_V int 1 regular {axi_s 0 volatile  { in_stream Dest } }  }
	{ input_local int 32 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "in_stream_V_data_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "in_stream_V_id_V", "interface" : "axis", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "in_stream_V_dest_V", "interface" : "axis", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "input_local", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ input_local_din sc_out sc_lv 32 signal 7 } 
	{ input_local_full_n sc_in sc_logic 1 signal 7 } 
	{ input_local_write sc_out sc_logic 1 signal 7 } 
	...
	{ in_stream_TID sc_in sc_lv 4 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "input_local_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "input_local", "role": "din" }} , 
 	{ "name": "input_local_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "input_local", "role": "full_n" }} , 
 	{ "name": "input_local_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "input_local", "role": "write" }} , 
 	...
 	{ "name": "in_stream_TID", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "in_stream_V_id_V", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "myproject_axi_Pipeline_VITIS_LOOP_30_1",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "input_local", "Type" : "Fifo", "Direction" : "O",
				"BlockSignal" : [
...
set ArgLastReadFirstWriteLatency {
	myproject_axi_Pipeline_VITIS_LOOP_30_1 {
		...
		input_local {Type O LastRead -1 FirstWrite 1}}}
...
set Spec2ImplPortList { 
	...
	in_stream_V_id_V { axis {  { in_stream_TID in_data 0 4 } } }
	in_stream_V_dest_V { axis {  { in_stream_TREADY in_acc 1 1 }  { in_stream_TDEST in_data 0 1 } } }
	input_local { ap_fifo {  { input_local_din fifo_data_in 1 32 }  { input_local_full_n fifo_status 0 1 }  { input_local_write fifo_port_we 1 1 } } }
}
