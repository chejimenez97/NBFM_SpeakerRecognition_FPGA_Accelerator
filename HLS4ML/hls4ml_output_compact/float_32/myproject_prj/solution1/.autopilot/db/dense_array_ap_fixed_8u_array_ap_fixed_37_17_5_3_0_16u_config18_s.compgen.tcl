...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { layer18_out_din { O 592 vector } layer18_out_num_data_valid { I 2 vector } layer18_out_fifo_cap { I 2 vector } layer18_out_full_n { I 1 bit } layer18_out_write { O 1 bit } } \
} "
}
