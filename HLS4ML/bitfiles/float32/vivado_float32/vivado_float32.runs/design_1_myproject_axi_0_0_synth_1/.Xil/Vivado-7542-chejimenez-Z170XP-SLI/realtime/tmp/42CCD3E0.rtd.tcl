...
set genomeRtd $env(RT_TMP)/42CCD3E0.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {myproject_axi_myproject__GCB6}]"
...
set genomeName [subst -nocommands -novariables {myproject_axi_myproject__GCB6}]
