...
set genomeRtd $env(RT_TMP)/88A06100.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {myproject_axi_dense_latency_ap_fixed_ap_fixed_40_20_5_3_0_config12_mult_s__GB0}]"
...
set genomeName [subst -nocommands -novariables {myproject_axi_dense_latency_ap_fixed_ap_fixed_40_20_5_3_0_config12_mult_s__GB0}]
