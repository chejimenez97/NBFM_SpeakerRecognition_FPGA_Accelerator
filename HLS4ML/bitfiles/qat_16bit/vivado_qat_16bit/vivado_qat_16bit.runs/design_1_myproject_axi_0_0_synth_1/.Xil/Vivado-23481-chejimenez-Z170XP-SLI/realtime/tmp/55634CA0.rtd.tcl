...
set genomeRtd $env(RT_TMP)/55634CA0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {myproject_axi_myproject__GCB7}]"
...
set genomeName [subst -nocommands -novariables {myproject_axi_myproject__GCB7}]
