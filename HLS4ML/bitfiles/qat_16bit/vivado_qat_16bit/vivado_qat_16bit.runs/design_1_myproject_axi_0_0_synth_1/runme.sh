...
HD_PWD='/home/chejimenez/GitHub/NBFM_SpeakerRecognition_FPGA_Accelerator/bitfiles/qat_16bit/vivado_qat_16bit/vivado_qat_16bit.runs/design_1_myproject_axi_0_0_synth_1'
cd "$HD_PWD"
