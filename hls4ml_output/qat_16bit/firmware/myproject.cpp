...
void myproject(
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<weight18_t, 1024>(w18, "w18.txt");
    ...
    #pragma HLS STREAM variable=layer6_out depth=1410

    hls::stream<layer25_t> layer25_out("layer25_out");
    #pragma HLS STREAM variable=layer25_out depth=1716

    hls::stream<conv2_result_t> layer7_out("layer7_out");
    #pragma HLS STREAM variable=layer7_out depth=1410

    hls::stream<bn2_result_t> layer9_out("layer9_out");
    #pragma HLS STREAM variable=layer9_out depth=1410

    hls::stream<layer10_t> layer10_out("layer10_out");
    #pragma HLS STREAM variable=layer10_out depth=1410

    hls::stream<layer11_t> layer11_out("layer11_out");
    #pragma HLS STREAM variable=layer11_out depth=175

    hls::stream<layer26_t> layer26_out("layer26_out");
    #pragma HLS STREAM variable=layer26_out depth=259

    hls::stream<conv3_result_t> layer12_out("layer12_out");
    #pragma HLS STREAM variable=layer12_out depth=175

    hls::stream<bn3_result_t> layer14_out("layer14_out");
    #pragma HLS STREAM variable=layer14_out depth=175

    hls::stream<layer15_t> layer15_out("layer15_out");
    #pragma HLS STREAM variable=layer15_out depth=175

    hls::stream<layer16_t> layer16_out("layer16_out");
    #pragma HLS STREAM variable=layer16_out depth=8
