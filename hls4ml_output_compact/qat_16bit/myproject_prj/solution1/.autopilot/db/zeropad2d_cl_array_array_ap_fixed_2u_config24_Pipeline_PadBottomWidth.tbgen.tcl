set moduleName zeropad2d_cl_array_array_ap_fixed_2u_config24_Pipeline_PadBottomWidth
set isTopModule 0
...
set C_modelName {zeropad2d_cl<array,array<ap_fixed,2u>,config24>_Pipeline_PadBottomWidth}
