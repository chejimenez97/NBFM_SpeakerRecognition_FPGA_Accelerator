set moduleName relu_array_ap_fixed_32u_array_ap_ufixed_16_6_4_0_0_32u_relu_config20_s
set isTopModule 0
...
set C_modelName {relu<array<ap_fixed,32u>,array<ap_ufixed<16,6,4,0,0>,32u>,relu_config20>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer18_out int 1280 regular {fifo 0 volatile }  }
	{ layer20_out int 512 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "layer18_out", "interface" : "fifo", "bitwidth" : 1280, "direction" : "READONLY"} , 
 	{ "Name" : "layer20_out", "interface" : "fifo", "bitwidth" : 512, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer18_out_dout sc_in sc_lv 1280 signal 0 } 
	...
	{ layer20_out_din sc_out sc_lv 512 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer18_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1280, "type": "signal", "bundle":{"name": "layer18_out", "role": "dout" }} , 
 	...
 	{ "name": "layer20_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "layer20_out", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		"CDFG" : "relu_array_ap_fixed_32u_array_ap_ufixed_16_6_4_0_0_32u_relu_config20_s",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "layer20_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "1", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "layer20_out_blk_n", "Type" : "RtlSignal"}]}]}]}


set ArgLastReadFirstWriteLatency {
	relu_array_ap_fixed_32u_array_ap_ufixed_16_6_4_0_0_32u_relu_config20_s {
...
set Spec2ImplPortList { 
	layer18_out { ap_fifo {  { layer18_out_dout fifo_data_in 0 1280 }  { layer18_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer18_out_fifo_cap fifo_update 0 2 }  { layer18_out_empty_n fifo_status 0 1 }  { layer18_out_read fifo_port_we 1 1 } } }
	layer20_out { ap_fifo {  { layer20_out_din fifo_data_in 1 512 }  { layer20_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer20_out_fifo_cap fifo_update 0 2 }  { layer20_out_full_n fifo_status 0 1 }  { layer20_out_write fifo_port_we 1 1 } } }
}
