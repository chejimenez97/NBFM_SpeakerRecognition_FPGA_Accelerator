set moduleName relu_array_ap_fixed_16u_array_ap_ufixed_4_3_4_0_0_16u_relu_config15_s
set isTopModule 0
...
set C_modelName {relu<array<ap_fixed,16u>,array<ap_ufixed<4,3,4,0,0>,16u>,relu_config15>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer14_out int 544 regular {fifo 0 volatile }  }
	{ layer15_out int 64 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "layer14_out", "interface" : "fifo", "bitwidth" : 544, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer14_out_dout sc_in sc_lv 544 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer14_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":544, "type": "signal", "bundle":{"name": "layer14_out", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "relu_array_ap_fixed_16u_array_ap_ufixed_4_3_4_0_0_16u_relu_config15_s",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	relu_array_ap_fixed_16u_array_ap_ufixed_4_3_4_0_0_16u_relu_config15_s {
...
set Spec2ImplPortList { 
	layer14_out { ap_fifo {  { layer14_out_dout fifo_data_in 0 544 }  { layer14_out_num_data_valid fifo_status_num_data_valid 0 8 }  { layer14_out_fifo_cap fifo_update 0 8 }  { layer14_out_empty_n fifo_status 0 1 }  { layer14_out_read fifo_port_we 1 1 } } }
	layer15_out { ap_fifo {  { layer15_out_din fifo_data_in 1 64 }  { layer15_out_num_data_valid fifo_status_num_data_valid 0 8 }  { layer15_out_fifo_cap fifo_update 0 8 }  { layer15_out_full_n fifo_status 0 1 }  { layer15_out_write fifo_port_we 1 1 } } }
}
