set moduleName dense_array_ap_ufixed_16u_array_ap_fixed_13_11_5_3_0_10u_config21_s
set isTopModule 0
...
set C_modelName {dense<array<ap_ufixed,16u>,array<ap_fixed<13,11,5,3,0>,10u>,config21>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer20_out int 64 regular {fifo 0 volatile }  }
	{ layer21_out int 130 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "layer20_out", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "layer21_out", "interface" : "fifo", "bitwidth" : 130, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer21_out_din sc_out sc_lv 130 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer21_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":130, "type": "signal", "bundle":{"name": "layer21_out", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_wrapper_ap_ufixed_ap_fixed_13_11_5_3_0_config21_s_fu_97", "Parent" : "0",
...
set Spec2ImplPortList { 
	layer20_out { ap_fifo {  { layer20_out_dout fifo_data_in 0 64 }  { layer20_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer20_out_fifo_cap fifo_update 0 2 }  { layer20_out_empty_n fifo_status 0 1 }  { layer20_out_read fifo_port_we 1 1 } } }
	layer21_out { ap_fifo {  { layer21_out_din fifo_data_in 1 130 }  { layer21_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer21_out_fifo_cap fifo_update 0 2 }  { layer21_out_full_n fifo_status 0 1 }  { layer21_out_write fifo_port_we 1 1 } } }
}
