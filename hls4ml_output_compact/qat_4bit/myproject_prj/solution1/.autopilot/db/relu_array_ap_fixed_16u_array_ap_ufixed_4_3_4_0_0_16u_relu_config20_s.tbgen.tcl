set moduleName relu_array_ap_fixed_16u_array_ap_ufixed_4_3_4_0_0_16u_relu_config20_s
set isTopModule 0
...
set C_modelName {relu<array<ap_fixed,16u>,array<ap_ufixed<4,3,4,0,0>,16u>,relu_config20>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer18_out int 208 regular {fifo 0 volatile }  }
	{ layer20_out int 64 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "layer18_out", "interface" : "fifo", "bitwidth" : 208, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer18_out_dout sc_in sc_lv 208 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer18_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":208, "type": "signal", "bundle":{"name": "layer18_out", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	layer18_out { ap_fifo {  { layer18_out_dout fifo_data_in 0 208 }  { layer18_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer18_out_fifo_cap fifo_update 0 2 }  { layer18_out_empty_n fifo_status 0 1 }  { layer18_out_read fifo_port_we 1 1 } } }
	layer20_out { ap_fifo {  { layer20_out_din fifo_data_in 1 64 }  { layer20_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer20_out_fifo_cap fifo_update 0 2 }  { layer20_out_full_n fifo_status 0 1 }  { layer20_out_write fifo_port_we 1 1 } } }
}
