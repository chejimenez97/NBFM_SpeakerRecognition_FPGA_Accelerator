...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3", "5"],
		...
		"Port" : [
			{"Name" : "layer6_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "320", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "grp_zeropad2d_cl_array_array_ap_ufixed_4_3_4_0_0_8u_config25_Pipeline_PadMain_fu_28", "Port" : "layer6_out", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
			{"Name" : "layer25_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "408", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "grp_zeropad2d_cl_array_array_ap_ufixed_4_3_4_0_0_8u_config25_Pipeline_PadMain_fu_28", "Port" : "layer25_out", "Inst_start_state" : "4", "Inst_end_state" : "5"},
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_zeropad2d_cl_array_array_ap_ufixed_4_3_4_0_0_8u_config25_Pipeline_PadMain_fu_28", "Parent" : "0", "Child" : ["4"],
	...
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_zeropad2d_cl_array_array_ap_ufixed_4_3_4_0_0_8u_config25_Pipeline_PadMain_fu_28.flow_control_loop_pipe_sequential_init_U", "Parent" : "3"},
...
set Spec2ImplPortList { 
	layer6_out { ap_fifo {  { layer6_out_dout fifo_data_in 0 32 }  { layer6_out_num_data_valid fifo_status_num_data_valid 0 10 }  { layer6_out_fifo_cap fifo_update 0 10 }  { layer6_out_empty_n fifo_status 0 1 }  { layer6_out_read fifo_port_we 1 1 } } }
	layer25_out { ap_fifo {  { layer25_out_din fifo_data_in 1 32 }  { layer25_out_num_data_valid fifo_status_num_data_valid 0 10 }  { layer25_out_fifo_cap fifo_update 0 10 }  { layer25_out_full_n fifo_status 0 1 }  { layer25_out_write fifo_port_we 1 1 } } }
}
