...
extern "C"
void apatb_myproject_hw(void* __xlx_apatb_param_input_1, void* __xlx_apatb_param_layer23_out)
{
  ...
  try {
    ...
    myproject_hw_stub_wrapper(__xlx_apatb_param_input_1, __xlx_apatb_param_layer23_out);
    port1.buffer();
