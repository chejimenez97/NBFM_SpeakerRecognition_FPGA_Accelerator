set moduleName dense_array_ap_ufixed_8u_array_ap_fixed_13_11_5_3_0_16u_config18_s
set isTopModule 0
...
set C_modelName {dense<array<ap_ufixed,8u>,array<ap_fixed<13,11,5,3,0>,16u>,config18>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer16_out int 32 regular {fifo 0 volatile }  }
	{ layer18_out int 208 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "layer16_out", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "layer18_out", "interface" : "fifo", "bitwidth" : 208, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer18_out_din sc_out sc_lv 208 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer18_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":208, "type": "signal", "bundle":{"name": "layer18_out", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3"],
		...
		"Port" : [
			{"Name" : "layer16_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_dense_array_array_ap_fixed_13_11_5_3_0_16u_config18_Pipeline_DataPrepare_fu_97", "Port" : "layer16_out", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_dense_array_array_ap_fixed_13_11_5_3_0_16u_config18_Pipeline_DataPrepare_fu_97", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dense_array_array_ap_fixed_13_11_5_3_0_16u_config18_Pipeline_DataPrepare_fu_97.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_wrapper_ap_ufixed_ap_fixed_13_11_5_3_0_config18_s_fu_119", "Parent" : "0",
...
set Spec2ImplPortList { 
	...
	layer18_out { ap_fifo {  { layer18_out_din fifo_data_in 1 208 }  { layer18_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer18_out_fifo_cap fifo_update 0 2 }  { layer18_out_full_n fifo_status 0 1 }  { layer18_out_write fifo_port_we 1 1 } } }
}
