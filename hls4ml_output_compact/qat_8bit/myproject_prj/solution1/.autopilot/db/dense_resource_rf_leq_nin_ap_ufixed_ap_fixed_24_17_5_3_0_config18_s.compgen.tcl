...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler myproject_sparsemux_57_5_8_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {auto}
}


set id 1908
set name myproject_mac_muladd_8ns_3s_13s_13_1_1
...
set in2_signed 1
set out_width 13
set arg_lists {i0 {8 0 +} i1 {3 1 +} m {11 1 +} i2 {13 1 +} p {13 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler myproject_dense_resource_rf_leq_nin_ap_ufixed_ap_fixed_24_17_5_3_0_config18_s_w18_ROM_Nctx BINDTYPE {storage} TYPE {rom_np} IMPL {bram} LATENCY 2 ALLOW_PRAGMA 1
}
