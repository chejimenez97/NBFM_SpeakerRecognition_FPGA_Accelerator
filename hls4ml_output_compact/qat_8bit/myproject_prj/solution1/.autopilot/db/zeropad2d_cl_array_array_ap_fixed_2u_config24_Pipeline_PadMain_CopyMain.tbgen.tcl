set moduleName zeropad2d_cl_array_array_ap_fixed_2u_config24_Pipeline_PadMain_CopyMain
set isTopModule 0
...
set C_modelName {zeropad2d_cl<array,array<ap_fixed,2u>,config24>_Pipeline_PadMain_CopyMain}
...
set portList { 
	...
	{ input_3_TVALID sc_in sc_logic 1 invld 1 } 
	{ input_3_TDATA sc_in sc_lv 32 signal 1 } 
	{ input_3_TREADY sc_out sc_logic 1 inacc 1 } 
}
set NewPortList {[ 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "16922", "Max" : "16922"}
	, {"Name" : "Interval", "Min" : "16922", "Max" : "16922"}
]}
...
set Spec2ImplPortList { 
	...
	input_3 { axis {  { input_3_TVALID in_vld 0 1 }  { input_3_TDATA in_data 0 32 }  { input_3_TREADY in_acc 1 1 } } }
}
