...
const Port_Property HLS_Design_Meta::port_props[]={
	Port_Property("input_3_TDATA", 32, hls_in, 0, "axis", "in_data", 1),
	Port_Property("layer23_out_TDATA", 160, hls_out, 1, "axis", "out_data", 1),
	Port_Property("ap_clk", 1, hls_in, -1, "", "", 1),
	Port_Property("ap_rst_n", 1, hls_in, -1, "", "", 1),
	Port_Property("input_3_TVALID", 1, hls_in, 0, "axis", "in_vld", 1),
	Port_Property("input_3_TREADY", 1, hls_out, 0, "axis", "in_acc", 1),
