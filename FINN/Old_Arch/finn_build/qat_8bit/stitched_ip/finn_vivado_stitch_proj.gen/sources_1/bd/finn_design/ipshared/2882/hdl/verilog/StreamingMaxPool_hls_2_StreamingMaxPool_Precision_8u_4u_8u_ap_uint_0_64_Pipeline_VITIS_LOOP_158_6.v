...
output  [0:0] buf_V_7_address0;
output   buf_V_7_ce0;
output   buf_V_7_we0;
output  [7:0] buf_V_7_d0;
input  [0:0] zext_ln156;
output  [0:0] buf_V_6_address0;
output   buf_V_6_ce0;
output   buf_V_6_we0;
output  [7:0] buf_V_6_d0;
output  [0:0] buf_V_5_address0;
output   buf_V_5_ce0;
output   buf_V_5_we0;
output  [7:0] buf_V_5_d0;
output  [0:0] buf_V_4_address0;
output   buf_V_4_ce0;
output   buf_V_4_we0;
output  [7:0] buf_V_4_d0;
output  [0:0] buf_V_3_address0;
output   buf_V_3_ce0;
output   buf_V_3_we0;
output  [7:0] buf_V_3_d0;
output  [0:0] buf_V_2_address0;
output   buf_V_2_ce0;
output   buf_V_2_we0;
output  [7:0] buf_V_2_d0;
output  [0:0] buf_V_1_address0;
output   buf_V_1_ce0;
output   buf_V_1_we0;
output  [7:0] buf_V_1_d0;
output  [0:0] buf_V_address0;
output   buf_V_ce0;
output   buf_V_we0;
output  [7:0] buf_V_d0;
...
assign icmp_ln158_1_fu_596_p2 = ((kx_2_fu_372_p2 == 3'd4) ? 1'b1 : 1'b0);

assign icmp_ln158_fu_366_p2 = ((ap_sig_allocacmp_kx_1 == 3'd4) ? 1'b1 : 1'b0);

assign kx_2_fu_372_p2 = (ap_sig_allocacmp_kx_1 + 3'd1);
