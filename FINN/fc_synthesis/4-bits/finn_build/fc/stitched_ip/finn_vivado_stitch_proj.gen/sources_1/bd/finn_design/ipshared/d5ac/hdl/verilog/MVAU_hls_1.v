...
(* CORE_GENERATION_INFO="MVAU_hls_1_MVAU_hls_1,hls_ip_2022_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xck26-sfvc784-2LV-c,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.249125,HLS_SYN_LAT=8200,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=883,HLS_SYN_LUT=1606,HLS_VERSION=2022_2}" *)
