...
module MVAU_hls_1_imp_ZIW0NT
  ...
  wire [31:0]MVAU_hls_1_out_V_TDATA;
  wire MVAU_hls_1_out_V_TREADY;
  wire MVAU_hls_1_out_V_TVALID;
  wire [143:0]MVAU_hls_1_wstrm_m_axis_0_TDATA;
  ...
  assign in0_V_1_TVALID = in0_V_tvalid;
  assign in0_V_tready = in0_V_1_TREADY;
  assign out_V_tdata[31:0] = MVAU_hls_1_out_V_TDATA;
...
module MVAU_hls_2_imp_1WP2WTL
  ...
  wire [15:0]MVAU_hls_2_out_V_TDATA;
  wire MVAU_hls_2_out_V_TREADY;
  wire MVAU_hls_2_out_V_TVALID;
  wire [71:0]MVAU_hls_2_wstrm_m_axis_0_TDATA;
  ...
  assign in0_V_1_TVALID = in0_V_tvalid;
  assign in0_V_tready = in0_V_1_TREADY;
  assign out_V_tdata[15:0] = MVAU_hls_2_out_V_TDATA;
...
module MVAU_hls_3_imp_U0RWZQ
  ...
  wire [31:0]MVAU_hls_3_out_V_TDATA;
  wire MVAU_hls_3_out_V_TREADY;
  wire MVAU_hls_3_out_V_TVALID;
  wire [143:0]MVAU_hls_3_wstrm_m_axis_0_TDATA;
  ...
  assign in0_V_1_TVALID = in0_V_tvalid;
  assign in0_V_tready = in0_V_1_TREADY;
  assign out_V_tdata[31:0] = MVAU_hls_3_out_V_TDATA;
...
module StreamingFIFO_rtl_13_imp_15RMZEY
   (ap_clk,
    ap_rst_n,
    in0_V_tdata,
    in0_V_tready,
...
module StreamingFIFO_rtl_15_imp_XRPGDM
  ...
  assign in0_V_1_TVALID = in0_V_tvalid;
  assign in0_V_tready = in0_V_1_TREADY;
  assign out_V_tdata[71:0] = fifo_M_AXIS_TDATA;
  assign out_V_tvalid = fifo_M_AXIS_TVALID;
...
module StreamingFIFO_rtl_19_imp_YM2KRV
   (ap_clk,
    ap_rst_n,
    in0_V_tdata,
    in0_V_tready,
...
module StreamingFIFO_rtl_21_imp_1JCHQQJ
   (ap_clk,
    ap_rst_n,
    in0_V_tdata,
    in0_V_tready,
...
module StreamingFIFO_rtl_6_imp_1F2U1JS
   (ap_clk,
    ap_rst_n,
    in0_V_tdata,
    in0_V_tready,
...
(* CORE_GENERATION_INFO = "finn_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=finn_design,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=74,numReposBlks=61,numNonXlnxBlks=6,numHierBlks=13,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=7,numHdlrefBlks=41,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "finn_design.hwdef" *) 
module finn_design
   (ap_clk,
    ap_rst_n,
    m_axis_0_tdata,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 m_axis_0 " *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME m_axis_0, CLK_DOMAIN finn_design_ap_clk_0, FREQ_HZ 200000000, HAS_TKEEP 0, HAS_TLAST 0, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.0, TDATA_NUM_BYTES 2, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) output [15:0]m_axis_0_tdata;
  ...
  wire MVAU_rtl_0_out_V_TREADY;
  wire MVAU_rtl_0_out_V_TVALID;
  wire [255:0]StreamingDataWidthConverter_rtl_0_out_V_TDATA;
  wire StreamingDataWidthConverter_rtl_0_out_V_TREADY;
  wire StreamingDataWidthConverter_rtl_0_out_V_TVALID;
  wire [63:0]StreamingDataWidthConverter_rtl_10_out_V_TDATA;
  ...
  wire [71:0]StreamingDataWidthConverter_rtl_2_out_V_TDATA;
  wire StreamingDataWidthConverter_rtl_2_out_V_TREADY;
  wire StreamingDataWidthConverter_rtl_2_out_V_TVALID;
  wire [255:0]StreamingDataWidthConverter_rtl_3_out_V_TDATA;
  ...
  wire [71:0]StreamingDataWidthConverter_rtl_5_out_V_TDATA;
  ...
  wire [71:0]StreamingDataWidthConverter_rtl_8_out_V_TDATA;
  wire StreamingDataWidthConverter_rtl_8_out_V_TREADY;
  wire StreamingDataWidthConverter_rtl_8_out_V_TVALID;
  wire [511:0]StreamingDataWidthConverter_rtl_9_out_V_TDATA;
  ...
  wire [71:0]StreamingFIFO_rtl_15_out_V_TDATA;
  ...
  wire [15:0]StreamingFIFO_rtl_27_out_V_TDATA;
  ...
  wire [255:0]StreamingFIFO_rtl_5_out_V_TDATA;
  ...
  assign StreamingFIFO_rtl_27_out_V_TREADY = m_axis_0_tready;
  assign ap_clk_0_1 = ap_clk;
  assign ap_rst_n_0_1 = ap_rst_n;
  assign in0_V_0_1_TDATA = s_axis_0_tdata[7:0];
  assign in0_V_0_1_TVALID = s_axis_0_tvalid;
  assign m_axis_0_tdata[15:0] = StreamingFIFO_rtl_27_out_V_TDATA;
  assign m_axis_0_tvalid = StreamingFIFO_rtl_27_out_V_TVALID;
  ...
  StreamingFIFO_rtl_13_imp_15RMZEY StreamingFIFO_rtl_13
       (.ap_clk(ap_clk_0_1),
        .ap_rst_n(ap_rst_n_0_1),
  ...
  StreamingFIFO_rtl_19_imp_YM2KRV StreamingFIFO_rtl_19
       (.ap_clk(ap_clk_0_1),
        .ap_rst_n(ap_rst_n_0_1),
  ...
  StreamingFIFO_rtl_21_imp_1JCHQQJ StreamingFIFO_rtl_21
       (.ap_clk(ap_clk_0_1),
        .ap_rst_n(ap_rst_n_0_1),
  ...
  StreamingFIFO_rtl_6_imp_1F2U1JS StreamingFIFO_rtl_6
       (.ap_clk(ap_clk_0_1),
        .ap_rst_n(ap_rst_n_0_1),
