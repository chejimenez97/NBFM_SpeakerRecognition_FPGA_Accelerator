...
set genomeRtd $env(RT_TMP)/ADCCBBC0.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {myproject_axi_GT0}]"
...
set genomeName [subst -nocommands -novariables {myproject_axi_GT0}]
