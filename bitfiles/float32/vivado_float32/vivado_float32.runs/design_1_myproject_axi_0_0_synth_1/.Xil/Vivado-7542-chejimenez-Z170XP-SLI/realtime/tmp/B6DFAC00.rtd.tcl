...
set genomeRtd $env(RT_TMP)/B6DFAC00.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {myproject_axi_GT1__1}]"
...
set genomeName [subst -nocommands -novariables {myproject_axi_GT1__1}]
