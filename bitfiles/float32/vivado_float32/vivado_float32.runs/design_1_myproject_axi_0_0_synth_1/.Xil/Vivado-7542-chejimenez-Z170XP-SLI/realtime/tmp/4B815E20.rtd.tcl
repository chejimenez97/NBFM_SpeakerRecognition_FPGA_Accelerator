...
set genomeRtd $env(RT_TMP)/4B815E20.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {myproject_axi_compute_output_buffer_2d_array_array_ap_fixed_40_20_5_3_0_8u_config7_s__GC0}]"
...
set genomeName [subst -nocommands -novariables {myproject_axi_compute_output_buffer_2d_array_array_ap_fixed_40_20_5_3_0_8u_config7_s__GC0}]
