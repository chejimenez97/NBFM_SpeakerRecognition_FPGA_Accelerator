...
HD_PWD='/home/chejimenez/GitHub/NBFM_SpeakerRecognition_FPGA_Accelerator/bitfiles/float32/vivado_float32/vivado_float32.runs/design_1_zynq_ultra_ps_e_0_0_synth_1'
cd "$HD_PWD"
